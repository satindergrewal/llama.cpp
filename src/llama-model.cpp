        ...
        case LLM_ARCH_MINIMAX_M3:
            {
                ...
                auto * msa = new llama_kv_cache_msa(
                        *this,
                        params.type_k,
                        params.type_v,
                        !cparams.flash_attn,
                ...
                if (llm_arch_is_recurrent(arch)) {
                    ...
                    if (hparams.swa_type != LLAMA_SWA_TYPE_NONE) {
                        ...
                        auto * hybrid_iswa = new llama_memory_hybrid_iswa(
                            ...
                            /* recurrent_rs_size */ llama_hybrid_rs_size(cparams.n_seq_max, cparams.kv_paged),
                        ...
                        auto * hybrid = new llama_memory_hybrid(
                            ...
                            /* recurrent_kv_size */ llama_hybrid_rs_size(cparams.n_seq_max, cparams.kv_paged),
                            /* n_seq_max         */ cparams.n_seq_max,
                            /* n_rs_seq          */ cparams.n_rs_seq,
                            /* offload           */ cparams.offload_kqv,
                            /* unified           */ cparams.kv_unified,
